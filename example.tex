...
\usepackage[english]{babel} % Language specific typesetting rules
...
\begin{frame}[fragile]
	\sidebysideright{
		\lstinputlisting[basicstyle=\tiny]{theme/config.json.template}
	}{
